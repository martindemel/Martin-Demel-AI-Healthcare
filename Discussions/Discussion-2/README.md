...
The main challenge was understanding how different data sources (EHR charted values vs. continuous monitor streams) can disagree for the same variable and how that missingness or conflict affects the reliability of an AI model trained on that data.
